...
const App = (_: any, state: AppState, setState: SetState) => {
    ...
    const {
        ...
        theme = 'light',
        md = true,
        title = 'Why the name "**Infima**"?',
        siteTitle = 'Infima',
        logo = 'https://facebookincubator.github.io/infima/img/logo.png',
    ...
    const docusaurusValue = docusaurusStamp ? '1' : '0';
    const url = new URL(window.location.origin);
    url.pathname = `${encodeURIComponent(title)}.${fileType}`;
    url.searchParams.append('md', mdValue);
    url.searchParams.append('theme', theme);
    url.searchParams.append('siteTitle', encodeURIComponent(siteTitle));
    url.searchParams.append('logo', logo);
    url.searchParams.append('docusaurusStamp', docusaurusValue);
